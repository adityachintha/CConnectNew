    ...
    const fullTimeJobs = [
        {
            ...
            description: 'Develop and maintain software applications. Experience with React Native and Node.js required.',
            location: 'Toronto, ON',
        ...
        },
        {
            ...
            description: 'Manage project timelines, budgets, and teams. PMP certification preferred.',
        ...
        },
        {
            ...
            description: 'Create and implement marketing strategies to increase brand awareness.',
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.tabButtonContainer}>
                {/* Part-Time Tab */}
                <TouchableOpacity onPress={selectTab1} accessibilityLabel="Part-time jobs" accessibilityHint="Tap to view part-time jobs">
                    <Text style={[styles.tabText, selectedTab === 1 && styles.activeTabText]}>Part-time</Text>
                    {selectedTab === 1 && <View style={styles.underline} />}
                </TouchableOpacity>

                {/* Full-Time Tab */}
                <TouchableOpacity onPress={selectTab2} accessibilityLabel="Full-time jobs" accessibilityHint="Tap to view full-time jobs">
