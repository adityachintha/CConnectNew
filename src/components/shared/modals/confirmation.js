...
//
// const confirmation = ({ visible, onClose, onShare }) => {
//     return (
...
const Confirmation = ({ visible, onClose }) => {
    ...
    const handleShare = () => {
        // Close the initial modal and open the job confirmation modal
        onClose(); // Close the confirmation modal
        setJobModalVisible(true); // Open the job confirmation modal
    };
    ...
    return (
        <>
            ...
            <JobConfirmationModal visible={isJobModalVisible} onClose={closeJobModal} />
        </>
    );
};
